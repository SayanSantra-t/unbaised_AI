...
flowchart TD
    ...
    %% Accurate Supreme Fallback Logic based on main.py
    AUD -- "Local loop exhausted (3×)\nSends Final Local Draft" --> SUP
    SUP -- "Passes Audit" --> RESULT
    SUP -- "Fails Audit (Biased)" --> FAIL
